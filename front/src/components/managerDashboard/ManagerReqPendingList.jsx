...
const ManagerReqPendingList = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const res = await axios.get(`http://localhost:5000/requestByManagerReqPending/?q=${query}`);
      setRequestByManagerReqPending(res.data);
    };
  ...
  return (
    <div>
      ...
      <h2 className="subtitle" style={txt}>Pending Request</h2>
       <input
        className="search"
        placeholder="Search..."
        // FaSearch
              ...
              <td>
                ...
                <td>
                  <Link
                    ...
                    style={{ backgroundColor: 'black', color: 'White', fontWeight: 500, fontSize: '20px', textDecoration:'none' }}
                  >
                    Take Action
                  </Link>
